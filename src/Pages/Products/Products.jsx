...
const Products = () => {
    ...
    console.log(reviews);
    return (
        <div className="my-10 max-w-6xl mx-auto px-4 md:px-6 lg:px-0">
            <div >
                {/* filter */}
                <div className="flex flex-col md:flex-row md:gap-2 md:items-center">
                    {/* cateegory filter */}
                    <div className="dropdown my-2 lg:my-8">
                    ...
                    {/* sort */}
                    <div className="dropdown my-2 md:my-8">
            ...
            {/* cards */}
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2 md:gap-3 lg:gap-8">
